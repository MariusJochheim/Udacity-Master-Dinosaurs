...
- [x] Remove any `console.log` and ensure no errors occur on click.
- [x] Apply Udacity JS style: descriptive names, functions declared before use, brief comments for non-obvious logic.
- [x] Manual verify: click “Compare Me!”, form hides, 9 tiles appear, human centered, pigeon fact fixed, random facts vary after refresh/new data.
